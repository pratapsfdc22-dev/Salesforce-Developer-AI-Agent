...
**Command**:
```bash
cd {{ $json.deployDir }} && sf project deploy start --source-dir force-app --target-org your-email@example.com --dry-run --json
```
...
- `--target-org your-email@example.com` - Your authenticated org
...
# Should show:
# your-email@example.com (Connected)
```
...
- [x] Org authenticated: `your-email@example.com`
