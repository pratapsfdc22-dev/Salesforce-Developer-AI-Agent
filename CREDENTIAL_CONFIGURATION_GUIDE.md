...
1. **Log into Salesforce**:
   - Go to: https://<your-org>.my.salesforce.com
   - Login as: your-email@example.com
...
1. **Open n8n**:
   - Go to: https://<your-n8n-instance>.app.n8n.cloud
...
2. **Configure "Deploy via Tooling API" Node**:
   ...
   - In the node settings panel:
     ...
     - **Credential for Salesforce OAuth2 API**: Select **Salesforce - your-org-name**
...
2. Update these Jira nodes:
   - **Jira Trigger - New SF Story**: Select credential `Jira - your-jira-credential`
   - **Jira - Get Issue Details**: Select credential `Jira - your-jira-credential`
   - **Jira - Post Questions Comment**: Select credential `Jira - your-jira-credential`
   - **Jira - Add Awaiting Response Label**: Select credential `Jira - your-jira-credential`
   - **Jira - Ready Comment**: Select credential `Jira - your-jira-credential`
   - **Jira - Add Ready Label**: Select credential `Jira - your-jira-credential`
3. Save workflow
...
2. Update these Jira nodes:
   - **Jira - Get Issue**: Select credential `Jira - your-jira-credential`
   - **Jira - Get Comments**: Select credential `Jira - your-jira-credential`
   - **Jira - More Questions Comment**: Select credential `Jira - your-jira-credential`
   - **Jira - Execute Comment**: Select credential `Jira - your-jira-credential`
   - **Jira - Remove Awaiting Label**: Select credential `Jira - your-jira-credential`
   - **Jira - Add Ready Label**: Select credential `Jira - your-jira-credential`
3. Save workflow
...
2. Update these Jira nodes:
   - **Jira - Get Issue**: Select credential `Jira - your-jira-credential`
   - **Jira - Starting Comment**: Select credential `Jira - your-jira-credential`
   - **Jira - Update to In Progress**: Select credential `Jira - your-jira-credential`
   - **Jira - Success Comment**: Select credential `Jira - your-jira-credential`
   - **Jira - Mark Done**: Select credential `Jira - your-jira-credential`
   - **Jira - Transition to Done**: Select credential `Jira - your-jira-credential`
   - **Jira - Validation Error Comment**: Select credential `Jira - your-jira-credential`
3. Save workflow
...
2. **Copy Production URL**:
   ...
   - Copy the URL (should be):
     ```
     https://<your-n8n-instance>.app.n8n.cloud/webhook/sf-agent-comment
     ```

### Step 2: Configure Webhook in Jira

1. **Go to Jira Settings**:
   - Visit: https://<your-domain>.atlassian.net
...
1. Re-authorize the credential:
   ...
   - Click on "Salesforce - your-org-name"
   - Click **Reconnect**
...
3. Verify domain format:
   - Should be: `<your-domain>.atlassian.net` (no `https://`)
...
|------------|-------------|---------|
| Salesforce OAuth2 | `Salesforce - your-org-name` | Tooling API deployment |
| Jira Software Cloud | `Jira - your-jira-credential` | Issue management |
...
- **Workflow 2 Webhook**: https://<your-n8n-instance>.app.n8n.cloud/webhook/sf-agent-comment
