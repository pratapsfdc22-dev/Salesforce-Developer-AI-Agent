...
```
Method: POST
URL: =https://<your-org>.my.salesforce.com/services/data/v64.0/tooling/sobjects/{{ $json.toolingRequests[0].type }}
...
**Target Org**: <your-org>.my.salesforce.com
...
2. **After that**, add:
   ...
   - URL: `https://<your-org>.my.salesforce.com/services/data/v64.0/tooling/sobjects/CustomField`
   - Method: POST
