...
- ✅ n8n cloud instance running: https://<your-n8n-instance>.app.n8n.cloud
- ✅ Salesforce org access: https://<your-org>.my.salesforce.com
- ✅ Jira instance access: https://<your-domain>.atlassian.net
...
- [ ] **1.1** Log into Salesforce: https://<your-org>.my.salesforce.com
...
- [ ] **1.4** Fill in:
  ...
  - Callback URL: `https://<your-n8n-instance>.app.n8n.cloud/rest/oauth2-credential/callback`
...
- [ ] **2.3** Add "Jira Software Cloud" credential:
  - Name: `Jira - your-jira-credential`
  - Email: `your-email@example.com`
...
- [ ] **4.3** Copy Production URL:
  ...
  ```
- [ ] **4.4** Go to Jira: https://<your-domain>.atlassian.net
...
- [ ] **6.1** Go to Jira: https://<your-domain>.atlassian.net
...
- **Documentation**: See all `.md` files in `/Users/<username>/Documents/n8nClaude/`
- **Workflow IDs**:
